...
VALUES
    (1, 'Apples', 'apple.jpg', 'Fresh, juicy apples', 'Fruits', 0.5, 1.99, 0, 'lb', 'NatureFresh', 'None', 'None', 'None', true, false, false, false, true, true, true, true, false, false, false),
    (2, 'Bananas', 'banana.jpg', 'Sweet, ripe bananas', 'Fruits', 0.3, 0.49, 0, 'lb', 'Tropical Delights', 'None', 'None', 'None', true, false, false, false, true, true, true, true, false, false, false),
    (3, 'Crispy Chips', 'chips.jpg', 'Delicious potato chips', 'Snacks', 0.2, 2.99, 0, 'bag', 'Tasty Treats', 'None', 'None', 'None', false, false, true, false, true, false, false, true, true, false, false),
    (4, 'Oranges', 'orange.jpg', 'Fresh, tangy oranges', 'Fruits', 0.4, 0.79, 0, 'lb', 'NatureFresh', 'None', 'None', 'None', true, false, false, false, true, true, true, true, false, false, false),
    (6, 'Grapes', 'grapes.jpg', 'Juicy red grapes', 'Fruits', 0.6, 2.49, 0, 'lb', 'Vineyard Delights', 'None', 'None', 'None', true, false, false, false, true, true, true, true, false, false, false),
    (3, 'Potato Chips', 'potato_chips.jpg', 'Classic potato chips', 'Snacks', 0.15, 1.49, 0, 'bag', 'SnackWorld', 'None', 'None', 'None', false, false, true, false, true, false, false, true, true, false, false),
    (2, 'Strawberries', 'strawberries.jpg', 'Fresh, sweet strawberries', 'Fruits', 0.3, 3.99, 0, 'lb', 'Berry Bliss', 'None', 'None', 'None', true, false, false, false, true, true, true, true, false, false, false),
    (5, 'Milk', 'milk.jpg', 'Fresh whole milk', 'Dairy', 1, 2.29, 0, 'gallon', 'DairyDelight', 'None', 'None', 'None', true, true, false, false, true, true, false, true, false, false, false),
    (1, 'Cereal', 'cereal.jpg', 'Nutty cereal flakes', 'Breakfast', 0.8, 3.99, 0, 'box', 'BreakfastBites', 'None', 'None', 'None', false, false, true, false, true, true, true, true, false, false, false),
    (9, 'Bread', 'bread.jpg', 'Fresh whole wheat bread', 'Bakery', 1, 2.99, 0, 'loaf', 'BakeryBest', 'None', 'None', 'None', true, false, true, true, true, true, true, true, false, false, false),
    (10, 'Carrots', 'carrots.jpg', 'Crunchy, fresh carrots', 'Vegetables', 0.4, 0.89, 0, 'lb', 'Harvest Farms', 'None', 'None', 'None', true, false, false, false, true, true, true, true, false, false, false),
    (7, 'Eggs', 'eggs.jpg', 'Farm-fresh eggs', 'Dairy', 0.75, 1.99, 0, 'dozen', 'FarmFresheggs', 'None', 'None', 'None', true, true, false, false, true, true, false, true, false, false, false),
    (8, 'Juice', 'juice.jpg', 'Refreshing fruit juice', 'Beverages', 1, 3.49, 0, 'bottle', 'JuiceFusion', 'None', 'None', 'None', true, false, false, false, true, true, true, true, false, false, false),
    (2, 'Oranges', 'orange.jpg', 'Fresh, tangy oranges', 'Fruits', 0.4, 0.79, 0, 'lb', 'NatureFresh', 'None', 'None', 'None', true, false, false, false, true, true, true, true, false, false, false),
    (5, 'Tuna', 'tuna.jpg', 'Wild-caught tuna fillet', 'Seafood', 0.3, 6.99, 0, 'lb', 'OceanCatch', 'None', 'None', 'None', false, true, true, false, true, true, false, true, false, false, true),
    (3, 'Potato Chips', 'potato_chips.jpg', 'Classic potato chips', 'Snacks', 0.15, 1.49, 0, 'bag', 'SnackWorld', 'Contains soy', 'None', 'None', false, false, true, false, true, false, false, true, true, false, false),
    (1, 'Strawberries', 'strawberries.jpg', 'Fresh, sweet strawberries', 'Fruits', 0.3, 3.99, 0, 'lb', 'Berry Bliss', 'None', 'None', 'None', true, false, false, false, true, true, true, true, false, false, false),
    (4, 'Salmon', 'salmon.jpg', 'Wild-caught salmon fillet', 'Seafood', 0.5, 9.99, 0, 'lb', 'SeaHarvest', 'None', 'None', 'None', false, true, true, false, true, true, false, true, false, false, true),
    (6, 'Carrots', 'carrots.jpg', 'Crunchy, fresh carrots', 'Vegetables', 0.4, 0.89, 0, 'lb', 'Harvest Farms', 'None', 'None', 'None', true, false, false, false, true, true, true, true, false, false, false),
    (2, 'Apples', 'apple.jpg', 'Fresh, juicy apples', 'Fruits', 0.5, 1.99, 0, 'lb', 'NatureFresh', 'None', 'None', 'None', true, false, false, false, true, true, true, true, false, false, false),
    (3, 'Shrimp', 'shrimp.jpg', 'Wild-caught shrimp', 'Seafood', 0.2, 12.99, 0, 'lb', 'SeaTreasures', 'None', 'None', 'None', false, true, true, false, true, true, false, true, false, false, true),
    (5, 'Almonds', 'almonds.jpg', 'Crunchy roasted almonds', 'Nuts', 0.25, 4.49, 0, 'lb', 'NuttyBites', 'None', 'None', 'None', true, false, false, false, true, true, true, true, false, false, false),
